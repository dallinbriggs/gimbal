...
class Geopointer(object):
    ...
    def __init__(self):
        ...
        # Determined for a latitude of 40.24 deg
    ...
    def target_callback(self, msg):
        ...
        self.target_pos = np.array([self.lat2meter*msg.latitude, self.long2meter*msg.longitude, -msg.altitude])
    ...
    def mav_gps_callback(self, msg):
        ...
        self.pos = np.array([self.lat2meter*msg.latitude, self.long2meter*msg.longitude, -msg.altitude])
